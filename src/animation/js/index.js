// рџ“ќ Fetch all DOM nodes in jQuery and Snap SVG
...
// set weather types вЃпёЏ рџЊ¬ рџЊ§ в›€ вЂпёЏ
...
function drawCloud(cloud, i) {
  ...
  var arch =
    height + settings.cloudArch + Math.random() * settings.cloudArch
