const nav_auth = document.createElement("template");
...
customElements.define(
    ...
    class extends HTMLElement {
        constructor() {
            ...
            nav_auth_button.appendChild(x);
            x.appendChild(nav_auth.content.cloneNode(true));
            registration_link.onclick = event => {
                reg()
                set_hidden(state_registration)
            };
        }
    }
);

document.createElement("nav-auth");
